...
import { MatTable, MatColumnDef, MatHeaderCellDef, MatHeaderCell, MatCellDef, MatCell, MatRowDef, MatRow, MatNoDataRow } from "@angular/material/table";
...
@Component({
    ...
    imports: [NgClass, AutocompleteWithAddFunctionComponent, MatTable, MatColumnDef, MatHeaderCellDef, MatHeaderCell, MatCellDef, MatCell, MatIconButton, MatIcon, MatRowDef, MatRow, MatNoDataRow]
})
