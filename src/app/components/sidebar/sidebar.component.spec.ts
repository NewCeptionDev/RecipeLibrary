...
describe("SidebarComponent", () => {
  ...
  Object.values(ExtendedOption).forEach(option => {
    it(`should return ${option === ExtendedOption.EDIT || option === ExtendedOption.EDITRECIPE} when editRefActive`, () => {
      // @ts-ignore
      component.activeRef = option
      expect(component.editRefActive()).toBe(option === ExtendedOption.EDIT || option === ExtendedOption.EDITRECIPE)
    });
  })
